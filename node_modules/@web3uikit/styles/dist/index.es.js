...
const gradientColors = {
  beauBlue: "radial-gradient(106.45% 108.64% at 32.33% -4.84%, #ECF5FC 0.52%, #CEE4F3 100%)",
  ...
  goldShiny: "linear-gradient(113.54deg, rgba(199, 148, 37, 0.6) 14.91%, rgba(204, 147, 23, 0.6) 14.92%, rgba(181, 147, 24, 0) 45.98%, rgba(250, 228, 30, 0) 55.76%, rgba(219, 200, 26, 0) 55.76%), linear-gradient(147.17deg, #DBBB14 48.73%, #B38311 98.22%)",
  lightBlue: "linear-gradient(113.54deg, rgba(117, 183, 251, 0.531738) 14.91%, rgba(209, 103, 255, 0.03) 55.76%), linear-gradient(160.75deg, #427ACB 41.37%, #45FFFF 98.29%)",
  lightGrey: "linear-gradient(90deg,rgba(221, 221, 221, 0),rgba(232, 232, 232, 0.6),rgba(221, 221, 221, 0))",
  purpleToPink: "linear-gradient(113.54deg, rgba(103, 58, 194, 0.6) 14.91%, rgba(122, 74, 221, 0.498) 25.92%, rgba(209, 103, 255, 0.03) 55.76%), linear-gradient(160.75deg, #7A4ADD 41.37%, #D57BFF 98.29%)"
};
const getShade = (shade, percent) => `rgba(
    ${shade === "light" ? "255, 255, 255," : "0, 0, 0,"}
    ${String(percent / 100)}
  )`;
const colorPercentage = (color2, percentage) => {
  const r2 = parseInt(color2.slice(1, 3), 16);
  const g2 = parseInt(color2.slice(3, 5), 16);
  const b2 = parseInt(color2.slice(5, 7), 16);
  return `rgba(${r2},${g2},${b2},${Number(percentage) / 100})`;
};
const breakpoints = {
  xxl: "1400px",
  xl: "1200px",
...
reactIs_production_min$1.isElement = function(a) {
  return typeof a === "object" && a !== null && a.$$typeof === b$2;
};
...
reactIs_production_min$1.isValidElementType = function(a) {
  return typeof a === "string" || typeof a === "function" || a === d$1 || a === f$1 || a === e$1 || a === m$1 || a === n$2 || a === t$2 || typeof a === "object" && a !== null && (a.$$typeof === q$3 || a.$$typeof === p$2 || a.$$typeof === g$2 || a.$$typeof === h$1 || a.$$typeof === l$2 || a.$$typeof === u$1 || a.getModuleId !== void 0) ? true : false;
};
...
function M$1(a, b2, e2) {
  var d2, c2 = {}, k2 = null, h6 = null;
  if (b2 != null)
    for (d2 in b2.ref !== void 0 && (h6 = b2.ref), b2.key !== void 0 && (k2 = "" + b2.key), b2)
  ...
  return { $$typeof: l$1, type: a, key: k2, ref: h6, props: c2, _owner: K$1.current };
}
function N$1(a, b2) {
...
function R(a, b2, e2, d2, c2) {
  ...
  if (h6)
    return h6 = a, c2 = c2(h6), a = d2 === "" ? "." + Q$1(h6, 0) : d2, I$1(c2) ? (e2 = "", a != null && (e2 = a.replace(P$1, "$&/") + "/"), R(c2, b2, e2, "", function(a2) {
      return a2;
    })) : c2 != null && (O(c2) && (c2 = N$1(c2, e2 + (!c2.key || h6 && h6.key === c2.key ? "" : ("" + c2.key).replace(P$1, "$&/") + "/") + a)), b2.push(c2)), 1;
  h6 = 0;
  d2 = d2 === "" ? "." : d2 + ":";
  if (I$1(a))
    ...
    for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; )
      k2 = k2.value, f2 = d2 + Q$1(k2, g2++), h6 += R(k2, b2, e2, f2, c2);
  else if (k2 === "object")
...
react_production_min.cloneElement = function(a, b2, e2) {
  ...
  var d2 = C({}, a.props), c2 = a.key, k2 = a.ref, h6 = a._owner;
  if (b2 != null) {
    b2.ref !== void 0 && (k2 = b2.ref, h6 = K$1.current);
  ...
  return { $$typeof: l$1, type: a.type, key: c2, ref: k2, props: d2, _owner: h6 };
};
...
function stylis_min(W2) {
  function M2(d2, c2, e2, h6, a) {
    for (var m2 = 0, b2 = 0, v2 = 0, n2 = 0, q2, g2, x2 = 0, K2 = 0, k2, u2 = k2 = q2 = 0, l2 = 0, r2 = 0, I2 = 0, t2 = 0, B3 = e2.length, J2 = B3 - 1, y2, f2 = "", p2 = "", F3 = "", G3 = "", C2; l2 < B3; ) {
      ...
      if (b2 + n2 + v2 + m2 === 0) {
        ...
        switch (g2) {
          case 123:
            ...
            switch (q2) {
              case 64:
                ...
                t2 = k2.length;
                0 < A2 && (r2 = X2(O2, f2, I2), C2 = H2(3, k2, r2, c2, D2, z2, t2, g2, a, h6), f2 = r2.join(""), C2 !== void 0 && (t2 = (k2 = C2.trim()).length) === 0 && (g2 = 0, k2 = ""));
                if (0 < t2)
                  switch (g2) {
                    case 115:
                      f2 = f2.replace(da, ea);
                    ...
                    case 107:
                      ...
                      break;
                    default:
                      k2 = f2 + k2, h6 === 112 && (k2 = (p2 += k2, ""));
                  }
                else
                  k2 = "";
                break;
              default:
                k2 = M2(c2, X2(c2, f2, I2), k2, h6, a + 1);
            }
            F3 += k2;
            k2 = I2 = r2 = u2 = q2 = 0;
            f2 = "";
          ...
          case 59:
            ...
            if (1 < (t2 = f2.length))
              switch (u2 === 0 && (q2 = f2.charCodeAt(0), q2 === 45 || 96 < q2 && 123 > q2) && (t2 = (f2 = f2.replace(" ", ":")).length), 0 < A2 && (C2 = H2(1, f2, c2, d2, D2, z2, p2.length, h6, a, h6)) !== void 0 && (t2 = (f2 = C2.trim()).length) === 0 && (f2 = "\0\0"), q2 = f2.charCodeAt(0), g2 = f2.charCodeAt(1), q2) {
                case 0:
                  break;
                case 64:
                  if (g2 === 105 || g2 === 99) {
      ...
      switch (g2) {
        case 13:
        case 10:
          b2 === 47 ? b2 = 0 : 1 + q2 === 0 && h6 !== 107 && 0 < f2.length && (r2 = 1, f2 += "\0");
          0 < A2 * Y2 && H2(0, f2, c2, d2, D2, z2, p2.length, h6, a, h6);
          z2 = 1;
          D2++;
          break;
        case 59:
    ...
    if (0 < t2) {
      r2 = c2;
      if (0 < A2 && (C2 = H2(2, p2, r2, d2, D2, z2, t2, h6, a, h6), C2 !== void 0 && (p2 = C2).length === 0))
        return G3 + p2 + F3;
      p2 = r2.join(",") + "{" + p2 + "}";
      if (w2 * E2 !== 0) {
        w2 !== 2 || L2(p2, 2) || (E2 = 0);
  ...
  function X2(d2, c2, e2) {
    var h6 = c2.trim().split(ia);
    c2 = h6;
    var a = h6.length, m2 = d2.length;
    switch (m2) {
      case 0:
      case 1:
        var b2 = 0;
  ...
  function Z2(d2, c2, e2) {
    var h6 = c2.charCodeAt(0);
    33 > h6 && (h6 = (c2 = c2.trim()).charCodeAt(0));
    switch (h6) {
      case 38:
  ...
  function P2(d2, c2, e2, h6) {
    var a = d2 + ";", m2 = 2 * c2 + 3 * e2 + 4 * h6;
    if (m2 === 944) {
      d2 = a.indexOf(":", 9) + 1;
    ...
    switch (m2) {
      ...
      case 953:
        if (la.test(d2) === true)
          return (b2 = d2.substring(d2.indexOf(":") + 1)).charCodeAt(0) === 115 ? P2(d2.replace("stretch", "fill-available"), c2, e2, h6).replace(":fill-available", ":stretch") : a.replace(b2, "-webkit-" + b2) + a.replace(b2, "-moz-" + b2.replace("fill-", "")) + a;
        break;
      case 962:
        if (a = "-webkit-" + a + (a.charCodeAt(5) === 102 ? "-ms-" + a : "") + a, e2 + h6 === 211 && a.charCodeAt(13) === 105 && 0 < a.indexOf("transform", 10))
          return a.substring(0, a.indexOf(";", 27) + 1).replace(ma, "$1-webkit-$2") + a;
    }
    return a;
  }
  function L2(d2, c2) {
    var e2 = d2.indexOf(c2 === 1 ? ":" : "{"), h6 = d2.substring(0, c2 !== 3 ? e2 : 10);
    e2 = d2.substring(e2 + 1, d2.length - 1);
    return R2(c2 !== 2 ? h6 : h6.replace(na, "$1"), e2, c2);
  }
  function ea(d2, c2) {
    var e2 = P2(c2, c2.charCodeAt(0), c2.charCodeAt(1), c2.charCodeAt(2));
    return e2 !== c2 + ";" ? e2.replace(oa, " or ($1)").substring(4) : "(" + c2 + ")";
  }
  function H2(d2, c2, e2, h6, a, m2, b2, v2, n2, q2) {
    for (var g2 = 0, x2 = c2, w3; g2 < A2; ++g2) {
      switch (w3 = S2[g2].call(B2, d2, x2, e2, h6, a, m2, b2, v2, n2, q2)) {
        case void 0:
        case false:
        case true:
        case null:
  ...
  function B2(d2, c2) {
    ...
    e2 = [V2];
    if (0 < A2) {
      var h6 = H2(-1, c2, e2, e2, D2, z2, 0, 0, 0, 0);
      h6 !== void 0 && typeof h6 === "string" && (c2 = h6);
    }
    var a = M2(O2, e2, c2, 0, 0);
    0 < A2 && (h6 = H2(-2, a, e2, e2, D2, z2, a.length, 0, 0, 0), h6 !== void 0 && (a = h6));
    V2 = "";
    E2 = 0;
    z2 = D2 = 1;
    return a;
  ...
  return e2.prototype.generateAndInjectStyles = function(e3, t2, n2) {
    ...
    if (this.baseStyle && o.push(this.baseStyle.generateAndInjectStyles(e3, t2, n2)), this.isStatic && !n2.hash)
      ...
      for (var c2 = this.rules.length, u2 = te(this.baseHash, n2.hash), l2 = "", d2 = 0; d2 < c2; d2++) {
        var h6 = this.rules[d2];
        if (typeof h6 == "string")
          l2 += h6;
        else if (h6) {
          var p2 = Ne(h6, e3, t2, n2), f2 = Array.isArray(p2) ? p2.join("") : p2;
...
function ce(e2) {
  var t2, n2, r2, o, s = e2 === void 0 ? E : e2, i = s.options, a = i === void 0 ? E : i, c2 = s.plugins, u2 = c2 === void 0 ? w : c2, l2 = new stylis_min(a), d2 = [], h6 = function(e3) {
    function t3(t4) {
      if (t4)
        try {
          e3(t4 + "}");
...
function qe(e2, t2, n2) {
  var o = N(e2), i = !ke(e2), a = t2.attrs, c2 = a === void 0 ? w : a, d2 = t2.componentId, h6 = d2 === void 0 ? function(e3, t3) {
  ...
  }(e2) : p2, g2 = t2.displayName && t2.componentId ? Te(t2.displayName) + "-" + t2.componentId : t2.componentId || h6, S2 = o && e2.attrs ? Array.prototype.concat(e2.attrs, c2).filter(Boolean) : c2, A2 = t2.shouldForwardProp;
  ...
  var C2, I2 = new se(n2, g2, o ? e2.componentStyle : void 0), P2 = I2.isStatic && c2.length === 0, O2 = function(e3, t3) {
    return function(e4, t4, n3, r2) {
      var o2 = e4.attrs, i2 = e4.componentStyle, a2 = e4.defaultProps, c3 = e4.foldedComponentIds, d3 = e4.shouldForwardProp, h7 = e4.styledComponentId, p3 = e4.target;
      ...
      return t4.style && g3.style !== t4.style && (C3.style = v({}, t4.style, {}, g3.style)), C3.className = Array.prototype.concat(c3, h7, S3 !== h7 ? S3 : null, t4.className, g3.className).filter(Boolean).join(" "), C3.ref = w2, react.exports.createElement(_2, C3);
    }(C2, e3, t3, P2);
  };
  return O2.displayName = f2, (C2 = r$1.forwardRef(O2)).attrs = S2, C2.componentStyle = I2, C2.displayName = f2, C2.shouldForwardProp = A2, C2.foldedComponentIds = o ? Array.prototype.concat(e2.foldedComponentIds, e2.styledComponentId) : w, C2.styledComponentId = g2, C2.target = o ? e2.target : e2, C2.withComponent = function(e3) {
...
var He = function(e2) {
  return function e3(t2, r2, o) {
    if (o === void 0 && (o = E), !reactIs$2.exports.isValidElementType(r2))
...
const text = Ce`
    ...
    line-height: 24px;
`;
const textBold500 = Ce`
    font-weight: 500;
`;
const textBold = Ce`
    font-weight: 600;
`;
const textBold700 = Ce`
    font-weight: 700;
`;
const textSmall = Ce`
    font-size: 14px;
...
const rgbToHex = (rgb) => {
  ...
  let r2 = (+rgbArray[0]).toString(16);
  let g2 = (+rgbArray[1]).toString(16);
  let b2 = (+rgbArray[2]).toString(16);
  if (r2.length == 1)
    r2 = "0" + r2;
  if (g2.length == 1)
    g2 = "0" + g2;
...
const hexToRgb = (hex) => {
  ...
  return result ? ` ${parseInt(result[1], 16)}, ${parseInt(result[2], 16)}, ${parseInt(result[3], 16)} ` : "66, 135, 245";
};
export { H1Styled, H2Styled, hexToRgb as HexToRgb, PStyled, breakpoints, color, colorPercentage, fontBreakpoint, fontSize, fonts, getShade, gradientColors, resetButtonCSS, resetCSS, rgbToHex };
